...
export const seoData = {
  home: {
    ...
    description: 'Join BPL, a cooperative team-based Path of Exile community event where players compete to score points across multiple categories.',
    keywords: 'Path of Exile, PoE, gaming competition, community event, team-based, ARPG, BPL, private league',
  ...
  scores: {
    ...
    description: 'View live BPL leaderboards, team rankings, and scoring across all Path of Exile competition categories.',
    keywords: 'BPL leaderboard, Path of Exile rankings, PoE competition scores, team standings',
    canonicalUrl: 'https://bpl-poe.com/scores/ladder',
    ogImage: 'https://bpl-poe.com/assets/app-logos/bpl-logo.webp',
  },
  rules: {
    title: 'BPL Rules & Guidelines | Path of Exile Competition Rules',
    description: 'Complete BPL rules, scoring categories, and competition guidelines for the Path of Exile private league community event.',
    keywords: 'BPL rules, Path of Exile competition rules, PoE event guidelines, scoring categories',
    canonicalUrl: 'https://bpl-poe.com/rules',
    ogImage: 'https://bpl-poe.com/assets/app-logos/bpl-logo.webp',
  },
  streams: {
    title: 'BPL Live Streams | Watch Path of Exile Streams',
    description: 'Watch live BPL streams from competing teams and players in the Path of Exile private league community event.',
    keywords: 'BPL streams, Path of Exile live streams, PoE competition streaming, gaming streams',
    canonicalUrl: 'https://bpl-poe.com/streams',
    ogImage: 'https://bpl-poe.com/assets/app-logos/bpl-logo.webp',
  },
  settings: {
    title: 'BPL Settings & Preferences | Account Configuration',
    description: 'Manage your BPL account settings, preferences, and Path of Exile character connections.',
    keywords: 'BPL settings, account preferences, PoE character linking, Oauth, Discord, Twitch, PoE',
    canonicalUrl: 'https://bpl-poe.com/settings',
    ogImage: 'https://bpl-poe.com/assets/app-logos/bpl-logo.webp',
  },
  submissions: {
    title: 'BPL Submissions | Submit Your Progress',
    description: 'Submit your Path of Exile bounties and boss kills for BPL scoring verification.',
  ...
  profile: {
    ...
    description: 'View your current and past characters, their gear and your contributions for your team.',
